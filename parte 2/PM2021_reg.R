...
#######################################################################################################
#                                                                                                     #
# HASTA ESTE PUNTO SE EJECUTA TODO CON LOS HIPERPARAMETROS CAMBIADOS Y A LA TABLA QUE VAN LOS ERRORES #
#                               FERFO ESTUVO AQUÍ                                                     #
#######################################################################################################
...
saveRDS(model,"e6_nnet.rds")
write.csv2(errors,"e6_finalErrors.csv")
write.csv2(iterativeErrors,"e6_iterativeErrors.csv")
write.csv2(outputsTrain,"e6_netOutputsTrain.csv")
write.csv2(outputsValid,"e6_netOutputsValid.csv")
write.csv2(outputsTest, "e6_netOutputsTest.csv") # este es necesario para mostrar el del mejor experimento
